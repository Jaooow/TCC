	...
	<div class = "container">
		<div id = "perfil">
			...
			<ul class="list-group">
				...
				<li class="list-group-item"><i class="fas fa-id-card"></i>Cargo:<span id="cargo"></span> <button id="mudar_cargo" class="btn btn-primary" href="mudar_cargo.php" >Mudar cargo para vendedor</button></li>
